...
void test_const_eval() {
    ...
    int min_abstract_float_to_i64 = int(global_4);
    int max_abstract_float_to_i64 = int(global_5);
    uint min_abstract_float_to_u64 = uint(global_4);
    uint max_abstract_float_to_u64 = uint(global_5);
}
