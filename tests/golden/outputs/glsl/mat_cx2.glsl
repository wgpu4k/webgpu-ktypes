...
layout(set = 0, binding = 0) buffer mat2x2 global_0;
layout(set = 0, binding = 1) uniform mat2x2 global_1;
layout(set = 2, binding = 0) buffer mat2x2[4] global_2;
layout(set = 2, binding = 1) uniform mat2x2[4] global_3;
...
void access_am() {
    int idx = 1;
    idx = (idx - 1);
    mat2x2[4] l_s_a = global_2;
    mat2x2 l_s_m_c = global_2[0];
    mat2x2 l_s_m_v = global_2[idx];
    ...
    mat2x2[4] l_u_a = global_3;
    mat2x2 l_u_m_c = global_3[0];
    mat2x2 l_u_m_v = global_3[idx];
...
void access_sasm() {
    ...
    mat2x2 l_s_m_c = global_6.a[0].m;
    mat2x2 l_s_m_v = global_6.a[idx].m;
    ...
    mat2x2 l_u_m_c = global_7.a[0].m;
    mat2x2 l_u_m_v = global_7.a[idx].m;
