...
var<private> positions: array<vec4<f32>, 3> = array<vec4<f32>, 3>(vec4<f32>(0.0f, 1.0f, 0.0f, 1.0f), vec4<f32>(-(1.0f), -(1.0f), 0.0f, 1.0f), vec4<f32>(1.0f, -(1.0f), 0.0f, 1.0f));
var<private> colors: array<vec4<f32>, 3> = array<vec4<f32>, 3>(vec4<f32>(0.0f, 1.0f, 0.0f, 1.0f), vec4<f32>(0.0f, 0.0f, 1.0f, 1.0f), vec4<f32>(1.0f, 0.0f, 0.0f, 1.0f));
