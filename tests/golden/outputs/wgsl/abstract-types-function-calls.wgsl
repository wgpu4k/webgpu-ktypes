...
var<private> const_af: i32 = 0;
var<private> const_ai: i32 = 0;
var<private> const_vec_af: vec2<f32> = vec2<f32>(0.0f);
var<private> const_vec_ai: vec2<f32> = vec2<f32>(0);
var<private> const_mat_af: mat2x2<f32> = mat2x2<f32>(vec2<f32>(0.0f), vec2<f32>(0.0f));
var<private> const_arr_af: array<f32, 2> = array<f32, 2>(0.0f, 0.0f);
var<private> const_arr_ai: array<i32, 2> = array<i32, 2>(0, 0);
...
fn main() {
    ...
    func_mf(mat2x2<f32>(vec2<f32>(0.0f), vec2<f32>(0.0f)));
