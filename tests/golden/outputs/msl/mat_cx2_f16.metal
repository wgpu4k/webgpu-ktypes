...
void access_am() {
    ...
    float4x2 local_2 = global_2[0];
    float4x2 local_3 = global_2[local_0];
    ...
    float4x2 local_17 = global_3[0];
    float4x2 local_18 = global_3[local_0];
...
void access_sasm() {
    ...
    float4x2 local_3 = global_6.a[0].m;
    float4x2 local_4 = global_6.a[local_0].m;
    ...
    float4x2 local_19 = global_7.a[0].m;
    float4x2 local_20 = global_7.a[local_0].m;
...
[[kernel]]
void main(float4x2 global_0 [[buffer(0)]], float4x2 global_1 [[buffer(1)]], /* unknown type */ void global_2 [[buffer(0)]], /* unknown type */ void global_3 [[buffer(1)]], Struct_2 global_4 [[buffer(0)]], Struct_2 global_5 [[buffer(1)]], Struct_4 global_6 [[buffer(0)]], Struct_4 global_7 [[buffer(1)]]) {
}
