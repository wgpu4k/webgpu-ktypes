...
[[kernel]]
void cs_main(ulong global_0 [[buffer(0)]], array<long, 2> global_1 [[buffer(1)]], Struct_3 global_4 [[buffer(2)]]) {
    ...
    Struct_11 local_8 = atomicCompareExchangeWeak(&global_0, 1u, 2u);
    Struct_12 local_9 = atomicCompareExchangeWeak(&global_1[1], 1, 2);
    Struct_11 local_10 = atomicCompareExchangeWeak(&global_4.atomic_scalar, 1u, 2u);
    Struct_12 local_11 = atomicCompareExchangeWeak(&global_4.atomic_arr[1], 1, 2);
    Struct_11 local_12 = atomicCompareExchangeWeak(&global_2, 1u, 2u);
    Struct_12 local_13 = atomicCompareExchangeWeak(&global_3[1], 1, 2);
    Struct_11 local_14 = atomicCompareExchangeWeak(&global_5.atomic_scalar, 1u, 2u);
    Struct_12 local_15 = atomicCompareExchangeWeak(&global_5.atomic_arr[1], 1, 2);
}

/* unknown type */ void atomicStore(/* unknown type */ void arg_0, ulong arg_1) {
}

/* unknown type */ void atomicStore(/* unknown type */ void arg_0, long arg_1) {
}
...
/* unknown type */ void atomicAdd(/* unknown type */ void arg_0, ulong arg_1) {
}

/* unknown type */ void atomicAdd(/* unknown type */ void arg_0, long arg_1) {
}
...
/* unknown type */ void atomicSub(/* unknown type */ void arg_0, ulong arg_1) {
}

/* unknown type */ void atomicSub(/* unknown type */ void arg_0, long arg_1) {
}
...
/* unknown type */ void atomicMax(/* unknown type */ void arg_0, long arg_1) {
}
...
/* unknown type */ void atomicMin(/* unknown type */ void arg_0, long arg_1) {
}
...
/* unknown type */ void atomicAnd(/* unknown type */ void arg_0, ulong arg_1) {
}

/* unknown type */ void atomicAnd(/* unknown type */ void arg_0, long arg_1) {
}
...
/* unknown type */ void atomicOr(/* unknown type */ void arg_0, ulong arg_1) {
}

/* unknown type */ void atomicOr(/* unknown type */ void arg_0, long arg_1) {
}
...
/* unknown type */ void atomicXor(/* unknown type */ void arg_0, ulong arg_1) {
}

/* unknown type */ void atomicXor(/* unknown type */ void arg_0, long arg_1) {
}
...
/* unknown type */ void atomicExchange(/* unknown type */ void arg_0, ulong arg_1) {
}

/* unknown type */ void atomicExchange(/* unknown type */ void arg_0, long arg_1) {
}
...
Struct_12 atomicCompareExchangeWeak(/* unknown type */ void arg_0, long arg_1, long arg_2) {
}
