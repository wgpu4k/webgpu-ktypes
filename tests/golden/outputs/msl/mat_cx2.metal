...
void access_m() {
    int local_0 = 1;
    local_0 = (local_0 - 1);
    float2x2 local_1 = global_0;
    float2 local_2 = global_0[0];
    float2 local_3 = global_0[local_0];
    ...
    float2x2 local_8 = global_1;
    float2 local_9 = global_1[0];
    float2 local_10 = global_1[local_0];
...
void access_am() {
    int local_0 = 1;
    local_0 = (local_0 - 1);
    array<float2x2, 4> local_1 = global_2;
    float2x2 local_2 = global_2[0];
    float2x2 local_3 = global_2[local_0];
    float2 local_4 = global_2[0][0];
    float2 local_5 = global_2[0][local_0];
    float2 local_6 = global_2[local_0][0];
    float2 local_7 = global_2[local_0][local_0];
    ...
    array<float2x2, 4> local_16 = global_3;
    float2x2 local_17 = global_3[0];
    float2x2 local_18 = global_3[local_0];
    float2 local_19 = global_3[0][0];
    float2 local_20 = global_3[0][local_0];
    float2 local_21 = global_3[local_0][0];
    float2 local_22 = global_3[local_0][local_0];
...
void access_sm() {
    ...
    float2x2 local_2 = global_4.m;
    float2 local_3 = global_4.m[0];
    float2 local_4 = global_4.m[local_0];
    ...
    float2x2 local_10 = global_5.m;
    float2 local_11 = global_5.m[0];
    float2 local_12 = global_5.m[local_0];
...
void access_sasm() {
    ...
    float2x2 local_3 = global_6.a[0].m;
    float2x2 local_4 = global_6.a[local_0].m;
    float2 local_5 = global_6.a[0].m[0];
    float2 local_6 = global_6.a[0].m[local_0];
    float2 local_7 = global_6.a[local_0].m[0];
    float2 local_8 = global_6.a[local_0].m[local_0];
    ...
    float2x2 local_19 = global_7.a[0].m;
    float2x2 local_20 = global_7.a[local_0].m;
    float2 local_21 = global_7.a[0].m[0];
    float2 local_22 = global_7.a[0].m[local_0];
    float2 local_23 = global_7.a[local_0].m[0];
    float2 local_24 = global_7.a[local_0].m[local_0];
...
[[kernel]]
void main(float2x2 global_0 [[buffer(0)]], float2x2 global_1 [[buffer(1)]], array<float2x2, 4> global_2 [[buffer(0)]], array<float2x2, 4> global_3 [[buffer(1)]], Struct_2 global_4 [[buffer(0)]], Struct_2 global_5 [[buffer(1)]], Struct_4 global_6 [[buffer(0)]], Struct_4 global_7 [[buffer(1)]]) {
}
