...
float2x2 global_0 : register(u0);
float2x2 global_1 : register(b1);
float2x2 global_2[4] : register(u0);
float2x2 global_3[4] : register(b1);
Struct_2 global_4 : register(u0);
Struct_2 global_5 : register(b1);
Struct_4 global_6 : register(u0);
Struct_4 global_7 : register(b1);
