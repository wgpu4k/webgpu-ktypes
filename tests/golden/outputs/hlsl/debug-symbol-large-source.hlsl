...
Texture2D<float4> global_2 : register(t2);
SamplerState global_3 : register(t3);
Struct_6 global_4 : register(b0);
Struct_10 global_5 : register(u2);
Struct_11 global_6 : register(b0);
Struct_16 global_7 : register(b0);
Struct_17 global_8 : register(b0);
Struct_20 global_9 : register(u1);
...
gen_terrain_vertex_Output gen_terrain_vertex() {
    gen_terrain_vertex_Output stage_out;
