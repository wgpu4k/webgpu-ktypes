...
struct Struct_9 {
    void val_u16_array_2;
    void val_i16_array_2;
};
...
Struct_6 global_5 : register(u1);
Struct_6 global_6 : register(u3);
Struct_9 global_7 : register(u2);
Struct_9 global_8 : register(u4);
...
float int16_function(float x) {
    ...
    void local_7 = void(i16(1), i16(2), i16(3), i16(4));
    local_7[0] = local_0;
    local_0 = local_7[1];
    int local_8 = u16(1);
    ...
    float local_9 = asfloat(local_0);
    local_0 = asfloat(local_9);
